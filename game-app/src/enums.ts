...
export enum GameConfig {
	PADDLE_HEIGHT           = 42                       * GAME_SCALAR, //28
	...
	DEFAULT_MUSHROOM_HEIGHT = 16					   * GAME_SCALAR,
	DEFAULT_MUSHROOM_WIDTH  = 16					   * GAME_SCALAR,
	DEFAULT_PEPPER_HEIGHT   = 16					   * GAME_SCALAR,
	DEFAULT_PEPPER_WIDTH    = 16				 	   * GAME_SCALAR,
}
